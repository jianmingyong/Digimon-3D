...
public sealed class BasicEffectWithAlphaTest : Effect, IEffectMatrices, IEffectLights, IEffectFog
{
    ...
    private EffectParameter emissiveColorParam = null!;
    private EffectParameter specularColorParam = null!;
    private EffectParameter specularPowerParam = null!;
    private EffectParameter eyePositionParam = null!;
    private EffectParameter fogColorParam = null!;
    private EffectParameter fogVectorParam = null!;
    private EffectParameter worldParam = null!;
    private EffectParameter worldInverseTransposeParam = null!;
    private EffectParameter worldViewProjParam = null!;
    private EffectParameter alphaTestParam = null!;
    ...
    /// </summary>
    private BasicEffectWithAlphaTest(BasicEffectWithAlphaTest cloneSource) : base(cloneSource)
    {
    ...
    {
        return new BasicEffect(effect.GraphicsDevice)
        {
            DirectionalLight0 =
            {
